<div class="page-header navbar navbar-fixed-top">
    ...
    <div class="page-header-inner ">
        ...
        {{--                <img src="{{(url(assets('admin')).'/apps/img/logo_.png')}}" alt="logo" class="logo-default img-circle"--}}
        ...
        <div class="page-logo" style="background-color: #000000">
...
{{--                <img src="{{url('assets')}}/logo.png" alt="logo" class="logo-default"--}}
                     style="width: 45%;margin-top: 2px;"/> </a>
            <div class="menu-toggler sidebar-toggler">
