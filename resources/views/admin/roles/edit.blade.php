                            ...
                            <div class="form-body">
                                ...
                                <div class="tab-content">
                                    ...
                                    <div class="form-group form-md-line-input">
                                        ...
                                        <div class="col-md-10">
                                            <div class="md-checkbox-inline" style="background-color: #eef1f5">
                                                <div class="md-checkbox note note-success" style="width: 100%;background-color: #baffba">
...
{{--                                                        <input class="{{$permission->category}}" id="{{ $permission->name }}"  @if(isset($permission) && $permission->hasPermissionTo($permission->name) == $permission->name ) checked @endif   name="permissions[]" value="{{$permission->id}}" type="checkbox">--}}

                                                            <input class="{{$permission->category}}" id="{{ $permission->name }}" @if(isset($role) && $role->hasPermissionTo($permission->name)) checked @endif name="permissions[]" value="{{$permission->id}}" type="checkbox">

                                                            <label for="{{ $permission->name }}" style="margin-left: 10px">
                                                            <span></span>
                                                            <span class="check" style="margin-left: 14px"></span>
                                                            <span class="box" style="margin-left: 14px"></span> {{ $permission->name }} </label>
                                                    </div>
                                                    {{--                                                        <br>--}}
                                                    {{--                                                        <hr>--}}
                                                @endforeach
