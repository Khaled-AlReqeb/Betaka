                ...
                <div class="login_form">
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="form-group mt-3 position-relative">
                            ...
                            {{--                            <input id="is_active" type="email" hidden class="auth_input @error('is_active') is-invalid @enderror"  name="is_active" value="{{ old('is_active') }}" autocomplete="off" autofocus>--}}
                            {{--                            @error('is_active')--}}
                            <span class="invalid-feedback" role="alert">
                                        <strong>لقد تم تعطيل حسابك من قبل المشرف يرجى التواصل مع الدعم الفني لحل المشكلة</strong>
                                    </span>
                            {{--                            @enderror--}}
