        ...
        <div class="container">
            <div class="d-flex align-items-center justify-content-between">
                <div class="txt">
                    ...
                    {{--                                <p>{{ \Illuminate\Support\Facades\Session::get('warning') }}</p>--}}
                    {{--                            @endif--}}
                    @if (session('warning'))
                        <div class="alert alert-warning" style="background-color: #f55a5a;color: #ffffff" role="alert">
                            {{ \Illuminate\Support\Facades\Session::get('warning') }}
                        </div>
                    @endif
                    <form action="{{ route('addBetaka') }}">
